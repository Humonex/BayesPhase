...
root as `BayesPhase.py`. This wrapper lets the HapDup integration call a
BayesPhase script from the historical `submodules/BayesPhase/` location without
...
if __name__ == "__main__":
    ...
    target = repo_root / "BayesPhase.py"
